        ...
        <table className="w-full">
          <thead className="bg-gray-50 border-b border-gray-100">
            <tr>
              ...
              <th className="px-4 py-3 text-center text-xs font-semibold text-gray-600 uppercase tracking-wider">Setup Fee</th>
              <th className="px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Period End</th>
              <th className="px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Stripe Customer</th>
              <th className="px-4 py-3 text-left text-xs font-semibold text-gray-600 uppercase tracking-wider">Connect</th>
            ...
            {orgSettings.length === 0 ? (
              <tr>
                <td colSpan={8} className="px-4 py-12 text-center">
                  ...
                  <p className="text-gray-500 mt-2">No organizations found</p>
                </td>
              </tr>
            ) : (
              orgSettings.map((settings) => (
                <tr key={settings.id} className="hover:bg-gray-50 transition-colors">
                  <td className="px-4 py-3 text-sm">
                    <Link href={`/admin/orgs/${settings.orgId}`} className="text-blue-600 hover:underline font-medium">
                      {settings.org.name}
                    </Link>
                  </td>
                  ...
                  <td className="px-4 py-3 text-sm">
                    {settings.currentPeriodEnd ? (
                      <span className={new Date(settings.currentPeriodEnd) < new Date() ? "text-red-600 font-medium" : "text-gray-500"}>
